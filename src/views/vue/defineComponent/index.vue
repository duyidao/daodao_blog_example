...
<template>
  ...
  <UseTemplate title="header" :money="10000" @foo="console.log"></UseTemplate>
  <div class="text-center my-20 text-orange">我是其他的内容</div>
  <UseTemplate title="main" :money="3479"></UseTemplate>
  <div class="text-center my-20 text-orange">我是其他的内容</div>
  <div class="text-center my-20 text-orange">我是其他的内容</div>
