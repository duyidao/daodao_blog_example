...
<template>
  <div class="flex w-full h-full">
    <div class="menu relative">
      <el-menu class="h-full border-r-none overflow-auto pb-60"
      ...
      <el-icon
        class="absolute left-0 bottom-0 w-full h-60 items-center justify-end text-30 pr-25 cursor-pointer text-white bg-[var(--el-menu-bg-color)] transition-all duration-300"
